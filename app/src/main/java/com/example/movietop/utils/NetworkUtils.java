...
public class NetworkUtils {
    ...
    private static final String API_KEY = "47d0fbd40a297472dc4428a701c84473";
    private static final String LANGUAGE_VALUE = "ru-RU";
    private static final String SORT_BY_POPULARITY = "popularity.desc";
    private static final String SORT_BY_TOPRATED = "vote_average.desc";
    ...
    public static URL builURL(int sortBY, int page) {
        URL result = null;
        String methodOfSort;
        if (sortBY == POPULARITY) {
            methodOfSort = SORT_BY_POPULARITY;
        } else {
            methodOfSort = SORT_BY_TOPRATED;
        }
